...
public class test_Bishop : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        navMeshAgent.SetDestination(Utility.GetRandomPointOnNavMesh(transform.position, 20f, NavMesh.AllAreas));   //  Set the destination to the first waypoint
    }
